...
// Table: clients
//   Policy "Enable delete for authenticated" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "Enable insert for authenticated" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
